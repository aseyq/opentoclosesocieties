...
## ==== Domino =====
df_domino1<- read_csv(here::here("data","processed", "domino1.csv"))  %>% 
    filter(community_rank == 1)

df_domino2 <- read_csv(here::here("data","processed", "domino2.csv"))  %>% 
    filter(community_rank == 2)

df_domino3 <- read_csv(here::here("data","processed", "domino3.csv"))  %>% 
    filter(community_rank == 3)

df_domino4 <- read_csv(here::here("data","processed", "domino4.csv"))  %>% 
    filter(community_rank == 4)

df_domino5 <- read_csv(here::here("data","processed", "domino5.csv"))  %>% 
    filter(community_rank == 5)

df_domino6 <- read_csv(here::here("data","processed", "domino6.csv"))  %>% 
    filter(community_rank == 6)

df_domino7 <- read_csv(here::here("data","processed", "domino7.csv"))  %>% 
...
## ==== Lock-in =====
df_lockin1 <- read_csv(here::here("data","processed", "lockin1.csv"))  %>% 
    filter(community_rank == 1)

df_lockin2 <- read_csv(here::here("data","processed", "lockin2.csv"))  %>% 
    filter(community_rank == 2)

df_lockin3 <- read_csv(here::here("data","processed", "lockin3.csv"))  %>% 
    filter(community_rank == 3)

df_lockin4 <- read_csv(here::here("data","processed", "lockin4.csv"))  %>% 
    filter(community_rank == 4)

df_lockin5 <- read_csv(here::here("data","processed", "lockin5.csv"))  %>% 
    filter(community_rank == 5)

df_lockin6 <- read_csv(here::here("data","processed", "lockin6.csv"))  %>% 
    filter(community_rank == 6)

df_lockin7 <- read_csv(here::here("data","processed", "lockin7.csv"))  %>% 
    filter(community_rank == 7)
...
ggsave("figures/share_baseline_lockin_domino.png", width = 6, height = 4)
